...
typedef enum {
	...
	REQ_ORIG_CORE,
	REQ_ORIG_RSCH,
#if NATIVE_POSIX_802154_CSMA_CA_ENABLED
	REQ_ORIG_CSMA_CA,
#endif /* NATIVE_POSIX_802154_CSMA_CA_ENABLED */
#if NATIVE_POSIX_802154_ACK_TIMEOUT_ENABLED
	REQ_ORIG_ACK_TIMEOUT,
#endif /* NATIVE_POSIX_802154_ACK_TIMEOUT_ENABLED */
#if NATIVE_POSIX_802154_DELAYED_TRX_ENABLED
	REQ_ORIG_DELAYED_TRX,
#endif /* NATIVE_POSIX_802154_DELAYED_TRX_ENABLED */
} req_originator_t;
